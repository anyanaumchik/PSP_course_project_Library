...
public class User implements Serializable {
    ...
    public String toString() {
        return "User ID: " + ID + " lastname " + lastname + " name" + name + " surname " + surname + " password " + password + " login " + login + " country " + country
                + " city " + city + " street " + street + " gender " + gender + " status " + status;
    }
}
