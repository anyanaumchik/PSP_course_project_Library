...
public class ChitZalCatalogController {
    ...
    void initialize() throws SQLException, ClassNotFoundException {
        assert table != null : "fx:id=\"table\" was not injected: check your FXML file 'ChitZalCatalog.fxml'.";
        assert id != null : "fx:id=\"id\" was not injected: check your FXML file 'ChitZalCatalog.fxml'.";
        assert author != null : "fx:id=\"author\" was not injected: check your FXML file 'ChitZalCatalog.fxml'.";
        assert title != null : "fx:id=\"title\" was not injected: check your FXML file 'ChitZalCatalog.fxml'.";
        assert year != null : "fx:id=\"year\" was not injected: check your FXML file 'ChitZalCatalog.fxml'.";
        assert pages != null : "fx:id=\"pages\" was not injected: check your FXML file 'ChitZalCatalog.fxml'.";
        assert format != null : "fx:id=\"format\" was not injected: check your FXML file 'ChitZalCatalog.fxml'.";
        assert material != null : "fx:id=\"material\" was not injected: check your FXML file 'ChitZalCatalog.fxml'.";
        assert coefficient != null : "fx:id=\"coefficient\" was not injected: check your FXML file 'ChitZalCatalog.fxml'.";
        assert buttonbck != null : "fx:id=\"buttonbck\" was not injected: check your FXML file 'ChitZalCatalog.fxml'.";
