...
public class OrderDelController {
    ...
    void initialize() throws SQLException, ClassNotFoundException {
        assert add != null : "fx:id=\"add\" was not injected: check your FXML file 'OrderDel.fxml'.";
        assert clckbck != null : "fx:id=\"clckbck\" was not injected: check your FXML file 'OrderDel.fxml'.";
        assert comboidbook != null : "fx:id=\"comboidbook\" was not injected: check your FXML file 'OrderDel.fxml'.";
        clckbck.setOnAction (actionEvent -> {
            openNewWindow ("/sample/fxml/ArchiveAdminMenu.fxml",clckbck);
        });
        DatabaseHandler databaseHandler = new DatabaseHandler ();
        String select = "SELECT idbook FROM archive ";
        ...
        List<Archive> orders = new ArrayList<> ();
        while (resultSet.next ()){
            Archive archive = new Archive ();
            archive.setIDbook (resultSet.getInt (1));
            dbTypeList.add(String.valueOf (archive.getIDbook ()));
            orders.add (archive);
        }
