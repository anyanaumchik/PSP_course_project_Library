...
public class DatabaseHandler extends Configs {
    ...
    public void SignInUser(User user) throws SQLException, ClassNotFoundException {
        ...
        try {
            FileOutputStream fis = new FileOutputStream ("C:\\Users\\ASUS\\IdeaProjects\\kursProject\\users.txt");
    ...
    public void AddBook(Book book) throws SQLException, ClassNotFoundException {
        ...
        try {
            FileOutputStream fis = new FileOutputStream ("C:\\Users\\ASUS\\IdeaProjects\\kursProject\\books.txt");
            ObjectOutputStream ois = new ObjectOutputStream (fis);
    ...
    public void AddArchive(Archive archive) throws SQLException, ClassNotFoundException {
        ...
        try {
            FileOutputStream fis = new FileOutputStream ("C:\\Users\\ASUS\\IdeaProjects\\kursProject\\archives.txt");
            ObjectOutputStream ois = new ObjectOutputStream (fis);
    ...
    public void AddOrder(Order order) throws SQLException, ClassNotFoundException {
        ...
        try {
            FileOutputStream fis = new FileOutputStream ("C:\\Users\\ASUS\\IdeaProjects\\kursProject\\orders.txt");
            ObjectOutputStream ois = new ObjectOutputStream (fis);
...
//        while (resultSet.next ()) {
    ...
    public void AddLoan(Loan loan) throws SQLException, ClassNotFoundException {
        ...
        try {
            FileOutputStream fis = new FileOutputStream ("C:\\Users\\ASUS\\IdeaProjects\\kursProject\\loans.txt");
            ObjectOutputStream ois = new ObjectOutputStream (fis);
